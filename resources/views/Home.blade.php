...
<body class="overflow-x-hidden">
    ...
    <section class="hidden lg:block">
        <div class="relative w-full h-[633px]">
            {{-- Background Image --}}
            <img src="{{ asset('images/mix/' . (app()->getLocale() === 'ar' ? 'home-dark-bg.webp' : 'home-dark-bg.webp')) }}"
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div class="flex items-center gap-4 mt-12">
                    <a href="#speakers"
                        class="px-8 py-3 bg-[#7D876B] hover:bg-[#6d765b] text-white font-semibold rounded-lg transition-colors duration-300">
                        {{ __('hero.button_speakers') ?? 'Speakers' }}
                    </a>
                    <a href="#exhibitors"
                        class="px-8 py-3 bg-[#E6813E] hover:bg-[#d96e2f] text-white font-semibold rounded-lg transition-colors duration-300">
            ...
            <div class="flex flex-row h-full ">
                ...
                <div
                    ...
                    <div class="mb-4">
                        <div class="flex items-center gap-2 mb-4">
                            <div>
                                <img src="{{ asset('images/mix/Radar-animation.gif') }}" class="h-[45px] w-[45px]"
                                    alt="Pillars Icon" />
                            </div>
                ...
                <div class="w-1/2 flex items-center justify-center p-12">
                    <div class="w-full h-full rounded-lg overflow-hidden shadow-lg">
                        <img src="{{ asset('images/mix/hero-info.webp') }}" alt="Event Team"
        ...
        <div
            ...
            <div class="flex flex-col">
                ...
                <div class="w-full h-64 md:h-80 flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('images/mix/hero-info.webp') }}" alt="Event Team"
                        class="max-w-[250px] h-full object-cover">
                </div>
                ...
                <div class="w-full flex flex-col items-center justify-start p-6 md:p-8 text-center">
                    ...
                    <div class="mb-4 w-full">
                        <div class="flex items-center gap-2 mb-3 justify-center">
                            <div>
                                <img src="{{ asset('images/mix/Radar-animation.gif') }}" class="h-8 w-8 md:h-10 md:w-10"
                                    alt="Pillars Icon" />
                            </div>
        ...
        <div class="w-full h-12 md:h-14 bg-[#3C94C5] flex items-center justify-center">
            <div class="flex items-center h-full max-w-6xl mx-auto px-4 gap-3 md:gap-4 w-full justify-center">
                ...
                <div class="flex flex-shrink-0 {{ app()->getLocale() === 'ar' ? 'order-last' : 'order-first' }}">
                    <img src="{{ asset('images/mix/' . (app()->getLocale() === 'ar' ? 'Left-arrow.svg' : 'right-arrow.svg')) }}"
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-6 p-2 sm:p-3 sm:grid-cols-2 lg:grid-cols-4 justify-items-center">
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    ...
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#7D876B]
                        ...
                        <img src="{{ asset('images/mix/city-energy.gif') }}" alt="Innovation" class="h-[93px] w-[166px]" />
                    </div>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#E7B954]
                        rounded-t-[20px] rounded-b-none">
                        <img src="{{ asset('images/mix/city-planning.gif') }}" alt="Adaptation" class="h-[95px] w-[169px]" />
                    </div>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#3C94C5]
                        rounded-t-[20px] rounded-b-none">
                        <img src="{{ asset('images/mix/Recycling.gif') }}" alt="Circular Economy" class="h-[88px] w-[156px]" />
                    </div>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#E68238]
                        rounded-t-[20px] rounded-b-none">
                        <img src="{{ asset('images/mix/Investment-icon.gif') }}" alt="Climate Finance"
                            class="h-[98px] w-[98px]" />
                    </div>
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
                ...
                <div class="grid gap-6 lg:col-span-4 justify-items-center lg:justify-items-start">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        <img src="{{ asset('images/mix/book.svg') }}" class="w-[49px] h-[45px]" alt="">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="{{ asset('images/mix/world.svg') }}" class="w-[49px] h-[49px]" alt="">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="{{ asset('images/mix/chart.svg') }}" class="w-[49px] h-[49px]" alt="">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="mx-auto max-w-[320px] overflow-hidden rounded-2xl border border-slate-200">
                        <img src="{{ asset('images/mix/attendee-section.webp') }}" alt="Attendees"
                    ...
                    <div class="mx-auto mt-6 max-w-[360px]">
                      ...
                      shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                            ...
                            <img src="{{ asset('images/mix/newspaper.svg') }}" class="w-[49px] h-[49px]" alt="">
                ...
                <div class="grid gap-6 lg:col-span-4 justify-items-center lg:justify-items-start">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="{{ asset('images/mix/building.svg') }}" class="w-[49px] h-[49px]" alt="">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="{{ asset('images/mix/industry.svg') }}" class="w-[49px] h-[49px]" alt="">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="{{ asset('images/mix/rocket.svg') }}" class="w-[49px] h-[49px]" alt="">
        ...
        <div class="mx-auto max-w-6xl px-4 pb-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/book.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[45px] flex-shrink-0" alt="">
                    <div class="text-center">
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/world.svg') }}"
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/chart.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/building.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/industry.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            {{ __('hero.attendee_national_authorities') }}
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/rocket.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                ...
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg sm:col-span-2 transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="{{ asset('images/mix/newspaper.svg') }}"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        <img src="{{ asset('images/mix/back-icon.webp') }}" alt=""
                            class="absolute inset-0 h-full w-full object-cover" />
                        <div class="absolute inset-0"></div>

                        <!-- ICON -->
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/police.svg') }}" alt="" class="h-10 w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/graduation-cap.svg') }}" alt="" class="h-10 w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/bubble.svg') }}" alt="" class="h-10 w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/discussion.svg') }}" alt="" class="h-10 w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <!-- ICON -->
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/police.svg') }}" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/graduation-cap.svg') }}" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/bubble.svg') }}" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="{{ asset('images/mix/discussion.svg') }}" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
