    ...
    <div class="w-full min-h-screen bg-black flex flex-col justify-center items-center px-4 py-12">
        ...
        <div class="relative z-10 w-full max-w-2xl text-center">
            ...
            <div class="mb-6 sm:mb-8">
                <h1
                    class="text-9xl sm:text-[150px] font-bold font-['Montserrat'] text-blue-500 leading-none drop-shadow-lg">
                    404
                </h1>
            </div>
            ...
            <!-- Error Message -->
            <div class="mb-6 sm:mb-8">
                <h2 class="text-3xl sm:text-5xl font-bold font-['Montserrat'] text-white mb-4">
                    Page Not Found
                </h2>
                <p class="text-base sm:text-lg text-gray-300 font-['Montserrat'] leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 sm:mb-16">
                <!-- Home Button -->
                <a href="/"
                    class="px-8 py-3 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 rounded-md inline-flex justify-center items-center gap-2 transition-colors font-bold text-white text-base font-['Inter']">
                ...
                <a href="mailto:Sales@birba.om"
                    class="px-8 py-3 border-2 border-blue-500 hover:bg-blue-500/10 active:bg-blue-500/20 rounded-md inline-flex justify-center items-center gap-2 transition-colors font-bold text-blue-500 text-base font-['Inter']">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-zinc-900/50 border border-zinc-700 rounded-lg p-6 sm:p-8 backdrop-blur-sm">
                <h3 class="text-white text-lg font-bold font-['Montserrat'] mb-4">What Can You Do?</h3>
                <ul class="text-left space-y-3 text-gray-300 text-sm font-['Montserrat']">
                    <li class="flex gap-3">
