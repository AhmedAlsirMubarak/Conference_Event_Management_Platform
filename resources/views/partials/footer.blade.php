            ...
            <div class="grid grid-cols-5 gap-8 mb-12">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-5 h-5 relative shrink-0 flex items-center justify-center">
                                    <img src="{{ asset('footer-img/call.svg') }}" alt="Phone"
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-5 h-5 relative shrink-0 flex items-center justify-center">
                                    <img src="{{ asset('footer-img/whatsapp.svg') }}" alt="whatsapp"
                                        class="w-full h-full object-contain">
                                </div>
                            ...
                            <div class="flex gap-4 mt-4">
                                <a href="https://twitter.com/WeekSaudi87319" target="_blank" rel="noopener noreferrer"
                                    ...
                                    <img src="{{ asset('footer-img/x.svg') }}" alt="Twitter"
                                        class="w-full h-full">
                                </a>
                                <a href="https://www.instagram.com/saudiclimateweek?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                                    ...
                                    <img src="{{ asset('footer-img/insta.svg') }}" alt="Instagram"
                                        class="w-full h-full">
                                </a>
                                <a href="#" class="w-5 h-5 hover:opacity-70 transition" title="Facebook">
                                    <img src="{{ asset('footer-img/facebook.svg') }}" alt="Facebook"
                                        class="w-full h-full">
                                </a>
                                <a href="https://www.linkedin.com/company/saudi-climate-week/" target="_blank"
                                    ...
                                    title="LinkedIn">
                                    <img src="{{ asset('footer-img/linkedin.svg') }}" alt="LinkedIn"
                                        class="w-full h-full">
                                </a>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <a href="/home">
                            <img class="w-[100px] h-[69px]" src="{{ asset('footer-img/scw-logo.webp') }}"
                                alt="SCW Logo" />
                        </a>
                    </div>
                    ...
                    <div class="flex flex-col justify-start items-center gap-2.5">
                        ...
                        <div class=" inline-flex justify-end items-center gap-6">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-5 h-5 relative shrink-0 flex items-center justify-center">
                                    <img src="{{ asset('footer-img/calendar 1.svg') }}" alt="Date"
                                        class="w-full h-full object-contain">
                                </div>
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-5 h-5 relative shrink-0 flex items-center justify-center">
                                    <img src="{{ asset('footer-img/map.svg') }}" alt="Location"
                                        class="w-full h-full object-contain">
                                </div>
                                <div class="{{ app()->getLocale() === 'ar' ? 'text-right' : 'text-left' }}">
                ...
                <div class="flex justify-center items-center gap-11"
                    ...
                    <div class="flex flex-col justify-start items-center gap-2">
                        <a href="https://ecocode.sa/en/" target="_blank" rel="noopener noreferrer">
                            <img class="w-20 h-10" src="{{ asset('footer-img/ecocode-logo.webp') }}"
                                alt="Partner 1" />
                        </a>
                        <a href="https://ecocode.sa/en/" target="_blank" rel="noopener noreferrer"
                    ...
                    <div class="flex flex-col justify-start items-center gap-2">
                        <a href="https://www.birba.om" target="_blank" rel="noopener noreferrer">
                            <img class="w-20 h-10" src="{{ asset('footer-img/birba-logo-white.webp') }}"
                                alt="Partner 2" />
                        </a>
                        <a href="https://www.birba.om" target="_blank" rel="noopener noreferrer"
                            class="text-xs text-zinc-400 hover:text-white transition">
...
<div class="lg:hidden bg-gray-900 text-white py-6 px-4" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    <div class="max-w-full mx-auto space-y-5">
        ...
        <div class="space-y-2 text-center">
            <a href="/home">
                <img src="{{ asset('footer-img/scw-logo.webp') }}" alt="SCW Logo"
        ...
        <div class="text-center">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-center gap-2">
                    <img src="{{ asset('footer-img/call.svg') }}" alt="Phone" class="w-4 h-4">
                    <a href="tel:+966559509832" target="_blank" rel="noopener noreferrer"
                ...
                <div class="flex items-center justify-center gap-2">
                    <img src="{{ asset('footer-img/whatsapp.svg') }}" alt="WhatsApp" class="w-4 h-4">
                    <a href="https://wa.me/966510831535" target="_blank" rel="noopener noreferrer"
                        class="text-xs text-gray-400 hover:text-white transition" dir="ltr">
                        +966 51 083 1535
                    </a>
                ...
                <div class="flex justify-center gap-4 pt-3">
                    <a href="https://twitter.com/WeekSaudi87319" target="_blank" rel="noopener noreferrer"
                        class="w-5 h-5 hover:opacity-70 transition" title="Twitter">
                        <img src="{{ asset('footer-img/x.svg') }}" alt="Twitter" class="w-full h-full">
                    </a>
                    <a href="https://www.instagram.com/saudiclimateweek?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                        class="w-5 h-5 hover:opacity-70 transition" title="Instagram" target="_blank"
                        rel="noopener noreferrer">
                        <img src="{{ asset('footer-img/insta.svg') }}" alt="Instagram" class="w-full h-full">
                    </a>
                    <a href="#" class="w-5 h-5 hover:opacity-70 transition" title="Facebook">
                        <img src="{{ asset('footer-img/facebook.svg') }}" alt="Facebook" class="w-full h-full">
                    </a>
                    <a href="https://www.linkedin.com/company/saudiclimate-week/" target="_blank"
                        ...
                        <img src="{{ asset('footer-img/linkedin.svg') }}" alt="LinkedIn" class="w-full h-full">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="text-center py-2 border-t border-gray-800">
            ...
            <div class="flex justify-center items-center gap-3">
                <div class="flex flex-col items-center gap-1">
                    <a href="https://ecocode.sa/en/" target="_blank" rel="noopener noreferrer">
                        <img class="w-14 h-auto" src="{{ asset('footer-img/ecocode-logo.webp') }}"
                            alt="Ecocode" />
                    </a>
                    <a href="https://ecocode.sa/en/" target="_blank" rel="noopener noreferrer"
                        class="text-xs text-zinc-400 hover:text-white transition">
                ...
                <div class="flex flex-col items-center gap-1">
                    <a href="https://www.birba.om" target="_blank" rel="noopener noreferrer">
                        <img class="w-14 h-auto" src="{{ asset('footer-img/birba-logo-white.webp') }}"
                            alt="Birba" />
                    </a>
                    <a href="https://www.birba.om" target="_blank" rel="noopener noreferrer"
                        class="text-xs text-zinc-400 hover:text-white transition">
