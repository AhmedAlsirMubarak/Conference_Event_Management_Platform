            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="#" class="text-2xl font-bold text-white hover:text-blue-400 transition-colors">
                        <img src="/images/scw-logo.webp" alt="SCW Logo" class="w-[97.99px] h-[69px]">
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <img src="/images/birba-logo-white.webp" alt="Organizer 1" class="h-10 rounded">
                        <div class="w-px h-6 bg-gray-700"></div>
                        <img src="/images/ecocode-logo.webp" alt="Organizer 2" class="h-10 rounded">
                    </div>
                </div>
