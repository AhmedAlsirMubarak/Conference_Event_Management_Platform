<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 700px; margin: 0 auto; padding: 20px;">
        ...
        <p style="padding: 15px; background-color: #f9f9f9; border-left: 4px solid #e68238;">{{ $climateLeader->bio }}
        </p>
        ...
        <p style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
            <a href="http://localhost:8000/admin/climate-leaders/{{ $climateLeader->id }}"
                style="display: inline-block; padding: 10px 20px; background-color: #e68238; color: white; text-decoration: none; border-radius: 4px;">View
                in Admin Panel</a>
        </p>
