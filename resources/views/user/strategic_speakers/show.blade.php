...
@section('content')
    <div class="w-full max-w-4xl">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <div class="bg-linear-to-r from-green-50 to-emerald-50 px-8 py-8">
                <div class="flex items-start gap-6">
                    <!-- Photo -->
                    <div class="shrink-0">
                        <div
                            class="w-32 h-32 bg-white rounded-xl border-2 border-green-200 flex items-center justify-center overflow-hidden shadow-md">
                            @if ($speaker->photo)
                    ...
                    <div class="flex-1">
                        ...
                        @if ($speaker->title)
                            <p class="text-lg text-green-600 font-semibold mb-1">{{ $speaker->title }}</p>
                        @endif
                        @if ($speaker->company)
