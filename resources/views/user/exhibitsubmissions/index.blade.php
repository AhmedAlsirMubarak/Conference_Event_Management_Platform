...
@section('title', 'Exhibit Submissions | User Dashboard')

@section('header-title', 'Exhibit Submissions')
@section('header-subtitle', 'View your exhibit submissions')
    ...
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('user.exhibit-submissions.exportExcel') }}"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="{{ route('user.exhibit-submissions.search') }}"
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-end gap-1">
                                            <a href="{{ route('user.exhibit-submissions.show', $submission->id) }}"
