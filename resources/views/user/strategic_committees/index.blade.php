...
@section('title', 'Strategic Committee | User Dashboard')

@section('header-title', 'Strategic Committee')
@section('header-subtitle', 'Browse all strategic committee members')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('user.strategic_committees.index') }}" method="GET" class="flex gap-2 mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('user.strategic_committees.export') }}"
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            <a href="{{ route('user.strategic_committees.show', $member->id) }}"
            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                        ...
                        <p class="text-gray-500">Check back soon for strategic committee members.</p>
                    </div>
                </div>
            @endforelse
        </div>
