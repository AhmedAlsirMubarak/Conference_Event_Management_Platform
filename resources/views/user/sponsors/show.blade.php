            ...
            <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2">
                            <a href="{{ $sponsor->website }}" target="_blank"
                                class="text-lg text-green-600 hover:text-green-800 break-all inline-flex items-center gap-2">
                                {{ $sponsor->website }}
                ...
                <div class="grid grid-cols-2 gap-4 pt-6 border-t border-gray-200">
                    <div>
                        ...
                        <p class="text-gray-900 mt-2">{{ $sponsor->created_at->format('F d, Y') }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">Updated</label>
                        <p class="text-gray-900 mt-2">{{ $sponsor->updated_at->format('F d, Y') }}</p>
                    </div>
                </div>
                ...
                <div class="pt-6 border-t border-gray-200">
                    <a href="{{ route('sponsors.index') }}"
                        class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                        Back to Sponsors
