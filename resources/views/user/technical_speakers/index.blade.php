...
@section('title', 'Technical Speakers')

@section('header-title', 'Technical Speakers')
@section('header-subtitle', 'View all technical speakers')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('user.technical_speakers.index') }}" method="GET" class="flex gap-2 mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('user.technical_speakers.export') }}"
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="{{ route('user.technical_speakers.show', $speaker->id) }}"
