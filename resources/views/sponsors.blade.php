...
<head>
    ...
    <title>{{ __(key: 'sponsors.hero_title') }}</title>
    <meta name="description" content="{{ __('sponsors.meta_description') }}">
    <meta name="keywords"
        content="sponsors, sponsorship enquiry, sustainability, recognition program, keynote sessions">
    <meta name="author" content="Saudi Climate Week">
    <meta name="robots" content="index, follow">

    <!-- Additional SEO Meta Tags -->
    <meta name="theme-color" content="#E68238">
    <meta name="apple-mobile-web-app-title" content="{{ __('sponsors.page_title') }}">
...
<body class="overflow-x-hidden" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    {{-- MOBILE: sponsor Hero / Banner --}}
    <section class="lg:hidden relative w-full overflow-hidden h-[400px]">
        {{-- Background image --}}
        <div class="absolute inset-0 bg-center bg-cover"
            style="background-image: url('{{ asset('images/mix/sponsors-hero.webp') }}');" aria-hidden="true"></div>
    ...
    {{-- DESKTOP & TABLET: sponsor Hero / Banner --}}
    ...
    <div class="bg-[#121D24] ">
        ...
        {{-- MOBILE: Why Sponsor Section --}}
        <section class="lg:hidden relative overflow-hidden rounded-t-[44px] pt-5 bg-center bg-cover text-white px-4"
            style="background-image: url('{{ asset('images/mix/why-bg.webp') }}'); ;">


            <div class="relative mx-auto max-w-md py-12">
                {{-- Title Section --}}
                <div class="text-center mb-10">
                    <h2 class="text-2xl font-extrabold leading-tight">
                        {!! __('sponsors.why_sponsor_title') !!}
                    </h2>

                    <p class="mt-4 text-sm leading-6 text-white/85">
                        {{ __('sponsors.why_sponsor_points') }}
                    </p>
                </div>
                ...
                <div class="space-y-5">
                    {{-- Thought Leadership --}}
                    <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-md">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10">
                            <img src={{ asset('images/mix/thought-leadership.svg') }} class='h-[24px] w-[24px]' alt=""
                                aria-hidden="true">
                        </div>
                        <h4 class="mt-4 text-lg font-extrabold leading-tight text-white">
                            {{ __('sponsors.Thought_Leadership') }}
                        </h4>
                        <p class="mt-2 text-sm leading-5 text-white/85">
                            {{ __('sponsors.Showcase_expertise') }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-md">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10">
                            <img src={{ asset('images/mix/strategic-positioning.svg') }} class='h-[24px] w-[24px]'
                                alt="" aria-hidden="true">
                        </div>
                        <h4 class="mt-4 text-lg font-extrabold leading-tight text-white">
                            {{ __('sponsors.Strategic_Positioning') }}
                        </h4>
                        <p class="mt-2 text-sm leading-5 text-white/85">
                            {{ __('sponsors.High-level_access') }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-md">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10">
                            <img src={{ asset('images/mix/cross.svg') }} class='h-[24px] w-[24px]' alt=""
                                aria-hidden="true">
                        </div>
                        <h4 class="mt-4 text-lg font-extrabold leading-tight text-white">
                            {{ __('sponsors.Cross-Sector_Engagement') }}
                        </h4>
                        <p class="mt-2 text-sm leading-5 text-white/85">
                            {{ __('sponsors.Engage_diverse_stakeholders') }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-md">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10">
                            <img src={{ asset('images/mix/decision-maker.svg') }} class='h-[24px] w-[24px]' alt=""
                                aria-hidden="true">
                        </div>
                        <h4 class="mt-4 text-lg font-extrabold leading-tight text-white">
                            {{ __('sponsors.Decision-Maker Access') }}
                        </h4>
                        <p class="mt-2 text-sm leading-5 text-white/85">
                            {{ __('sponsors.Direct_engagement') }}
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl bg-white/10 p-6 ring-1 ring-white/10 backdrop-blur-md">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10">
                            <img src={{ asset('images/mix/integrated.svg') }} class='h-[24px] w-[24px]' alt=""
                                aria-hidden="true">
                        </div>
                        <h4 class="mt-4 text-lg font-extrabold leading-tight text-white">
                            {{ __('sponsors.Integrated_Visibility') }}
                        </h4>
                        <p class="mt-2 text-sm leading-5 text-white/85">
                            {{ __('sponsors.Visibility_across') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        {{-- DESKTOP: Why Sponsor Section --}}
        <section class="hidden lg:block relative overflow-hidden rounded-t-[44px] pt-20 bg-center bg-cover text-white"
            style="background-image: url('{{ asset('images/mix/why-bg.webp') }}');">



            <div class="relative mx-auto max-w-6xl px-6 pb-70 pt-12 md:px-10 md:pt-14">
                <div class="grid gap-10 lg:grid-cols-3 lg:gap-10">

                    {{-- LEFT COLUMN (text + Thought Leadership card) --}}
                    <div class="flex flex-col gap-8">
                        <div>
                            <h2 class="text-2xl font-extrabold leading-tight md:text-3xl">
                                {!! __('sponsors.why_sponsor_title') !!}

                            </h2>

                            <p class="mt-4 max-w-sm text-[12px] leading-6 text-white/85">
                                {{ __('sponsors.why_sponsor_points') }}
                            </p>
                        </div>

                        {{-- Thought Leadership (bottom-left) --}}
                        <div class="rounded-2xl bg-white/10 p-7 ring-1 ring-white/10 backdrop-blur-md">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/10">
                                <img src={{ asset('images/mix/thought-leadership.svg') }} class='h-[55px] w-[55px]'
                                    alt="" aria-hidden="true">
                            </div>

                            <h4 class="mt-6 text-[22px] font-extrabold leading-tight text-white">
                                {{ __('sponsors.Thought_Leadership') }}
                            </h4>

                            <p class="mt-3 max-w-[290px] text-[15px] leading-6 text-white/85">
                                {{ __('sponsors.Showcase_expertise') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-10">
                        ...
                        <div class="rounded-2xl bg-white/10 p-7 ring-1 ring-white/10 backdrop-blur-md">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/10">
                                <img src={{ asset('images/mix/strategic-positioning.svg') }} class='h-[55px] w-[55px]'
                                    alt="" aria-hidden="true">
                            </div>
                        ...
                        <div class="rounded-2xl bg-white/10 p-7 ring-1 ring-white/10 backdrop-blur-md">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/10">
                                <img src={{ asset('images/mix/cross.svg') }} class='h-[55px] w-[55px]' alt=""
                                    aria-hidden="true">
                            </div>
                            ...
                            <p class="mt-3 max-w-[300px] text-[15px] leading-6 text-white/85">
                                {{ __('sponsors.Engage_diverse_stakeholders') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-10">
                        ...
                        <div class="rounded-2xl bg-white/10 p-7 ring-1 ring-white/10 backdrop-blur-md">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/10">
                                <img src={{ asset('images/mix/decision-maker.svg') }} class='h-[55px] w-[55px]' alt=""
                                    aria-hidden="true">
                            </div>
                        ...
                        <div class="rounded-2xl bg-white/10 p-7 ring-1 ring-white/10 backdrop-blur-md">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/10">
                                <img src={{ asset('images/mix/integrated.svg') }} class='h-[55px] w-[55px]' alt=""
                                    aria-hidden="true">
                            </div>
                ...
                {{-- Bottom wave image --}}
                <img src="{{ asset('images/mix/why-sponsor-section.webp') }}" alt=""
                    class="pointer-events-none absolute bottom-[-70px] left-1/2 w-screen max-w-none -translate-x-1/2 "
                    aria-hidden="true" />
            </div>
        </section>
    ...
    <div id="sponsor-enquiry-form"></div>
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center">
                <p class="text-[11px] font-semibold tracking-wide text-orange-400">
                    {{ __('sponsors.form_label') }}
                </p>

                <h1 class="mt-2 text-2xl font-extrabold tracking-tight">
                    {{ __('sponsors.form_title') }}
                </h1>

                <p class="mt-3 text-sm leading-6 text-white/60">
                    {!! __('sponsors.form_description') !!}
                </p>
            </div>

            <form action="{{ route('create.sponsorsubmission') }}" method="POST" class="mt-7 space-y-4">
                @csrf
                ...
                <div id="mobileSuccessMsg"
                    ...
                    <h3 class="font-bold text-green-400 text-sm">{{ __('sponsors.thank_you') }}
                    </h3>
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.contact_person_label') }}</label>
                    <input type="text" name="contact_person" required
                        placeholder="{{ __('sponsors.contact_person_placeholder') }}"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.job_title_label') }}</label>
                    <input type="text" name="job_title" required
                        placeholder="{{ __('sponsors.job_title_placeholder') }}"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.organization_label') }}</label>
                    <input type="text" name="organization_name" required
                        placeholder="{{ __('sponsors.organization_placeholder') }}"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.email_label') }}</label>
                    <input type="email" name="email_address" required
                        placeholder="{{ __('sponsors.email_placeholder') }}"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class=" mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.phone_label') }}</label>
                    <input type="text" name="phone_number" required placeholder="{{ __('sponsors.phone_placeholder') }}"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7 " />
                </div>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label
                            class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.country_label') }}</label>
                        <div class="relative">
                            <select name="country" required
                                ...
                                <option value="" selected disabled class="bg-slate-900">
                                    {{ __('sponsors.country_placeholder') }}
                                </option>
                    ...
                    <div>
                        <label
                            class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.website_label') }}</label>
                        <input type="url" name="website" required placeholder="{{ __('sponsors.website_placeholder') }}"
                            class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                    </div>
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.additional_comments_label') }}</label>
                    <textarea name="additional_comments" rows="4"
                        placeholder="{{ __('sponsors.additional_comments_placeholder') }}"
                ...
                <div class="pt-2">
                    <button type="submit"
                        ...
                        {{ __('sponsors.submit_button') }} <span
            ...
            <div class="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <div>
                    ...
                    <form action="{{ route('create.sponsorsubmission') }}" method="POST" class="mt-7 space-y-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" required
                                    placeholder="{{ __('sponsors.phone_placeholder') }}"
                                    class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="url" name="website" required
                                    placeholder="{{ __('sponsors.website_placeholder') }}"
                                    class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                            </div>
                        ...
                        <div>
                            <label
                                class="mb-2 block text-xs font-semibold text-white/70">{{ __('sponsors.additional_comments_label') }}
                            </label>
                            <textarea name="additional_comments" rows="4"
                                placeholder="{{ __('sponsors.additional_comments_placeholder') }}" class="w-full rounded-md border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50
                                 focus:bg-white/7"></textarea>
                        </div>

                        {{-- Submit --}}
                        <div class="pt-2">
                            <button type="submit" id="btnSubmitSponsorEnquiry"
                ...
                <div class="lg:pt-8">
                    <div class="relative mx-auto w-[457px] max-w-md lg:max-w-none">
                        <div class="overflow-hidden rounded-[28px]">
                            <img src="{{ asset('images/mix/sponsor-formbg.webp') }}" alt=""
