...
@section('title', 'Strategic Speakers | Admin Dashboard')

@section('header-title', 'Strategic Speakers')
@section('header-subtitle', 'Manage all strategic speakers')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('strategic_speakers.index') }}" method="GET" class="flex gap-2 mb-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('strategic_speakers.export') }}"
                ...
                <a href="{{ route('strategic_speakers.create') }}"
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="{{ route('strategic_speakers.show', $speaker->id) }}"
                            ...
                            <a href="{{ route('strategic_speakers.edit', $speaker->id) }}"
                            ...
                            <form action="{{ route('strategic_speakers.destroy', $speaker->id) }}" method="POST" class="flex-1"
