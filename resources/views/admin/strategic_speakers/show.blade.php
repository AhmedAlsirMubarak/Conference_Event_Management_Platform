        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <div class="bg-linear-to-r from-blue-50 to-indigo-50 px-8 py-8">
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        @if ($speaker->title)
                            <p class="text-lg text-blue-600 font-semibold mb-1">{{ $speaker->title }}</p>
                        @endif
                        @if ($speaker->company)
            ...
            <div class="px-8 py-4 bg-gray-50 border-t border-gray-200 flex items-center gap-3">
                <a href="{{ route('strategic_speakers.edit', $speaker->id) }}"
                    class="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium text-sm transition-colors">
