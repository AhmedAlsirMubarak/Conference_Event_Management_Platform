...
@section('title', 'Strategic Committee | Admin Dashboard')

@section('header-title', 'Strategic Committee')
@section('header-subtitle', 'Manage all strategic committee members')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('strategic_committees.index') }}" method="GET" class="flex gap-2 mb-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('strategic_committees.export') }}"
                ...
                <a href="{{ route('strategic_committees.create') }}"
                    ...
                    <div class="p-6">
                        ...
                        @if ($member->logo)
                            <div class="flex justify-center mb-4">
                                <img src="{{ asset('storage/uploads/' . $member->logo) }}" alt="Logo" class="h-16 w-16 object-contain">
                            </div>
                        @endif

                        <!-- Actions -->
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="{{ route('strategic_committees.show', $member->id) }}"
                            ...
                            <a href="{{ route('strategic_committees.edit', $member->id) }}"
                            ...
                            <form action="{{ route('strategic_committees.destroy', $member->id) }}" method="POST" class="flex-1"
            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                        ...
                        <p class="text-gray-500">Add your first strategic committee member.</p>
                    </div>
                </div>
            @endforelse
        </div>
