...
@section('title', 'Edit Strategic Committee Member | Admin')
...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8">
            <form action="{{ route('strategic_committees.update', $member->id) }}" method="POST"
                ...
                <div>
                    ...
                    @if ($member->logo)
                        <div class="mb-4">
                            <img src="{{ asset('storage/uploads/' . $member->logo) }}" alt="{{ $member->name }}"
