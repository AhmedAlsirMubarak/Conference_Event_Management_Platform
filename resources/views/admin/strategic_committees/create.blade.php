...
@section('title', 'Add Strategic Committee Member | Admin')

@section('header-title', 'Add Member')
@section('header-subtitle', 'Create a new strategic committee member')
...
@section('content')
    <div class="w-full max-w-2xl mx-auto px-0">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-8">
            <form action="{{ route('strategic_committees.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
