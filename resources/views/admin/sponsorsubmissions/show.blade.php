...
@section('header-subtitle', 'Submitted Sponsor enquiry information')
    ...
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        @if (Auth::user()->role === 'admin')
                            <form action="{{ route('sponsor-submissions.destroy', $submission->id) }}" method="POST" class="inline"
            ...
            <div class="p-8">
                ...
                <!-- Sponsor enquiry Comments Section -->
                ...
                <div class="mt-10 pt-8 border-t border-gray-200">
                    ...
                    <form action="{{ route('sponsor-submissions.updateNotes', $submission->id) }}" method="POST"
                        class="space-y-4">
                        @csrf
                        <div>
