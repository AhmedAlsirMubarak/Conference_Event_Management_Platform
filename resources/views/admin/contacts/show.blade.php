...
@section('header-subtitle', 'Submitted contact information')
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            @if ($contact->Designation)
                                <p class="text-blue-100 mt-1">{{ $contact->Designation }}</p>
                            @endif
                            <p class="text-blue-100 text-sm mt-2">Submitted {{ $contact->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
