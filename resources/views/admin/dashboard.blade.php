...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <!-- Sponsor Submissions Card -->
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">Sponsor Submissions</p>
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ $totalSponsorSubmissions ?? 0 }}</p>
