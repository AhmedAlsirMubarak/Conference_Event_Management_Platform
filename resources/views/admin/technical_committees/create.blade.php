...
@section('title', 'Add Technical Committee Member | Admin')

@section('header-title', 'Add Member')
@section('header-subtitle', 'Create a new technical committee member')
...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8">
            <form action="{{ route('technical_committees.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
