...
@section('title', 'Technical Committee | Admin Dashboard')

@section('header-title', 'Technical Committee')
@section('header-subtitle', 'Manage all technical committee members')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('technical_committees.index') }}" method="GET" class="flex gap-2 mb-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('technical_committees.export') }}"
                ...
                <a href="{{ route('technical_committees.create') }}"
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="{{ route('technical_committees.show', $member->id) }}"
            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                        ...
                        <p class="text-gray-500">Add your first technical committee member.</p>
                    </div>
                </div>
            @endforelse
        </div>
