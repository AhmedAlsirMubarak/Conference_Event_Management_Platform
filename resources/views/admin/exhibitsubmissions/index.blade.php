...
@section('title', 'Exhibit Submissions | Admin Dashboard')

@section('header-title', 'Exhibit Submissions')
@section('header-subtitle', 'Manage all exhibit submissions')
    ...
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('exhibit-submissions.exportExcel') }}"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="{{ route('exhibit-submissions.search') }}" class="flex flex-col sm:flex-row gap-2">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors submission-row"
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-end gap-1">
                                                <a href="{{ route('exhibit-submissions.show', $submission->id) }}"
                                                ...
                                                @if (Auth::check())
                                                    <form action="{{ route('exhibit-submissions.destroy', $submission->id) }}"
