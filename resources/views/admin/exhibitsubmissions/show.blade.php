...
@section('title', $submission->contact_person . ' | Exhibit Submissions')

@section('header-title', 'Exhibit Submission Details')
@section('header-subtitle', 'Submitted exhibit enquiry information')
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        @if (Auth::user()->role === 'admin')
                            <form action="{{ route('exhibit-submissions.destroy', $submission->id) }}" method="POST" class="inline"
            ...
            <div class="p-8">
                ...
                <div class="mt-10 pt-8 border-t border-gray-200">
                    ...
                    <form action="{{ route('exhibit-submissions.updateNotes', $submission->id) }}" method="POST"
                        class="space-y-4">
                        @csrf
                        <div>
                            ...
                            <textarea name="admin_notes" id="admin_notes" rows="5"
                                ...
                                placeholder="e.g., Called on Dec 8, interested in exhibiting. Follow-up scheduled for next week.">{{ $submission->admin_notes }}</textarea>
