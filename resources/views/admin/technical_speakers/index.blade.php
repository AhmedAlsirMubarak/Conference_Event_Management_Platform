...
@section('title', 'Technical Speakers | Admin Dashboard')

@section('header-title', 'Technical Speakers')
@section('header-subtitle', 'Manage all Technical Speakers')

@section('content')
    <div class="flex flex-col">
        <!-- Search Bar -->
        <div class="mb-6">
            <form action="{{ route('technical_speakers.index') }}" method="GET" class="flex gap-2 mb-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('technical_speakers.export') }}"
                ...
                <a href="{{ route('technical_speakers.create') }}"
                    ...
                    <div class="p-6">
                        ...
                        @if ($speaker->logo)
                            <div class="flex justify-center mb-4">
                                <img src="{{ asset('storage/' . $speaker->logo) }}" alt="Logo" class="h-16 w-16 object-contain">
                            </div>
                        @endif

                        <!-- Actions -->
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="{{ route('technical_speakers.show', $speaker->id) }}"
            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No speakers</h3>
                        <p class="mt-1 text-sm text-gray-500">Get started by creating a new speaker.</p>
                    </div>
                </div>
            @endforelse
        </div>
