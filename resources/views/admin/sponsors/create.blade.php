...
@section('header-title', 'Create Sponsor')
@section('header-subtitle', 'Add a new sponsor')
...
@section('content')
    <div class="w-full max-w-2xl mx-auto px-0">
        <a href="{{ route('sponsors.index') }}"
            ...
            <span class="hidden sm:inline">Back to Sponsors</span>
            ...
            <form action="{{ route('sponsors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required
                        ...
                        placeholder="Enter sponsor name" value="{{ old('name') }}">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="e.g., Technology, Hospitality" value="{{ old('category') }}">
                    @error('category')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
    ...
    <script>
        // Image preview functionality for sponsors
        ...
        // Create preview container after logo input
