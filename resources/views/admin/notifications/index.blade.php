...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const allNotificationsUrl = '{{ route("admin.notifications.all") }}';
            const markAllUrl = '{{ route("admin.notifications.markAllRead") }}';
            const deleteUrlPrefix = '/api/notifications';
                    ...
                    <div class="p-4 border border-gray-200 rounded-lg ${readClass} hover:shadow-md transition-shadow flex justify-between items-start gap-4">
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="mt-3 flex gap-2">
                                <a href="/contacts/${notif.contact_id}" class="text-xs text-blue-600 hover:text-blue-800 font-medium">
                                    View Contact
                                </a>
