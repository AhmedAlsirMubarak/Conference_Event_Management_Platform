...
@section('title', 'Speaker Submissions | Admin Dashboard')

@section('header-title', 'Speaker Submissions')
@section('header-subtitle', 'Manage all speaker submissions')
    ...
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('speaker-submissions.exportExcel') }}"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="{{ route('speaker-submissions.search') }}" class="flex flex-col sm:flex-row gap-2">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors submission-row"
                                            ...
                                            <div class="flex items-center gap-1">
                                                @if ($submission->notes)
                                                    <div class="flex-1 min-w-0">
                                                        <p class="text-xs text-gray-700 line-clamp-1" title="{{ $submission->notes }}">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-end gap-1">
                                                <a href="{{ route('speaker-submissions.show', $submission->id) }}"
                                                ...
                                                @if (Auth::check())
                                                    <form action="{{ route('speaker-submissions.destroy', $submission->id) }}"
