...
<?php $__env->startSection('title', 'Exhibit Submissions | Admin Dashboard'); ?>

<?php $__env->startSection('header-title', 'Exhibit Submissions'); ?>
<?php $__env->startSection('header-subtitle', 'Manage all exhibit submissions'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">All Exhibit Submissions</h3>
                <p class="text-sm text-gray-500 mt-1">Total: <?php echo e(count($submissions)); ?> submissions</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('exhibit-submissions.exportExcel')); ?>"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="<?php echo e(route('exhibit-submissions.search')); ?>" class="flex flex-col sm:flex-row gap-2">
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <?php if($submissions->isEmpty()): ?>
                <div class="p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">No exhibit submissions yet</h3>
                    <p class="text-gray-500">Exhibit submissions will appear here.</p>
                </div>
            <?php else: ?>
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                            ...
                            <tbody class="divide-y divide-gray-200" id="submissionsTableBody">
                                <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors submission-row"
                                        data-submission-id="<?php echo e($submission->id); ?>">
                                        <td class="px-4 py-3">
                                            <input type="checkbox"
                                                class="submission-checkbox w-4 h-4 border border-gray-300 rounded cursor-pointer"
                                                onchange="updateBulkActionsBar()" data-id="<?php echo e($submission->id); ?>">
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div class="min-w-0">
                                                    <p class="font-medium text-gray-900 truncate">
                                                        <?php echo e($submission->contact_person); ?>

                                                    </p>
                                                    <?php if($submission->job_title): ?>
                                                        <p class="text-xs text-gray-500 truncate"><?php echo e($submission->job_title); ?></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <a href="mailto:<?php echo e($submission->email_address); ?>"
                                                class="text-blue-600 hover:text-blue-800 text-xs break-all"><?php echo e($submission->email_address); ?></a>
                                        </td>
                                        <td class="px-4 py-3">
                                            <a href="tel:<?php echo e($submission->phone_number); ?>"
                                                class="text-gray-700 text-xs whitespace-nowrap">
                                                <?php echo e($submission->phone_number); ?></a>
                                        </td>
                                        <td class="px-4 py-3">
                                            <span class="text-gray-700 text-xs"><?php echo e($submission->organization_name ?? '-'); ?></span>
                                        </td>
                                        <td class="px-4 py-3">
                                            <span class="text-gray-700 text-xs"><?php echo e($submission->country ?? '-'); ?></span>
                                        </td>
                                        <td class="px-4 py-3">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-1">
                                                <?php if($submission->admin_notes): ?>
                                                    <div class="flex-1 min-w-0">
                                                        <p class="text-xs text-gray-700 line-clamp-1"
                                                            title="<?php echo e($submission->admin_notes); ?>">
                                                            <?php echo e(Str::limit($submission->admin_notes, 30)); ?>

                                                        </p>
                                                    </div>
                                                    <button type="button"
                                                        onclick="openNoteModal(<?php echo e($submission->id); ?>, '<?php echo e(addslashes($submission->admin_notes)); ?>')"
                                                ...
                                                <?php else: ?>
                                                    <button type="button" onclick="openNoteModal(<?php echo e($submission->id); ?>, '')"
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-end gap-1">
                                                <a href="<?php echo e(route('exhibit-submissions.show', $submission->id)); ?>"
                                                ...
                                                <?php if(Auth::check()): ?>
                                                    <form action="<?php echo e(route('exhibit-submissions.destroy', $submission->id)); ?>"
    ...
    <script>
        function openNoteModal(submissionId, noteText) {
            ...
            form.action = `/admin/exhibit-submissions/${submissionId}/notes`;
        ...
        function confirmBulkDelete() {
            ...
            submissionIds.forEach(id => {
                fetch(`/admin/exhibit-submissions/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': token,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SCW-app\resources\views/admin/exhibitsubmissions/index.blade.php ENDPATH**/ ?>