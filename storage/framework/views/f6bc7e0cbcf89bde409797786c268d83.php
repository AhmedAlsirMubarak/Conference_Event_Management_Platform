...
<head>
    ...
    <title><?php echo e(__(key: 'exhibit.hero_title')); ?></title>
    <meta name="description" content="<?php echo e(__('exhibit.meta_description')); ?>">
...
<body class="overflow-x-hidden" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <section class="lg:hidden relative w-full overflow-hidden h-[400px]">
        ...
        <div class="absolute inset-0 bg-center bg-cover"
            style="background-image: url('<?php echo e(asset('storage/mix/exhibit-hero.webp')); ?>');" aria-hidden="true"></div>
            ...
            <div class="text-center max-w-md">
                ...
                <div class="mt-6">
                    <a href="#exhibit-enquiry-form"
                        ...
                        <?php echo e(__('exhibit.hero_cta')); ?>
            ...
            <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6">
                ...
                <div class="text-center mb-6">
                    <h2 class="text-[24px] sm:text-[28px] font-extrabold tracking-tight text-slate-900">
                        <?php echo e(__('exhibit.about_title')); ?>

                    </h2>

                    <p class="mt-3 text-[14px] leading-6 text-slate-500">
                        <?php echo e(__('exhibit.about_description')); ?>
                    ...
                    <div class="mt-5 flex flex-col gap-3 items-center">
                        ...
                        <p class="text-[14px] leading-6 text-slate-500">
                            <?php echo e(__('exhibit.about_paragraph_2')); ?>
                ...
                <div class="text-center mb-6">
                    <div class="inline-block">
                        <h3 class="text-[24px] font-extrabold text-sky-600"><?php echo e(__('exhibit.about_why')); ?></h3>
                ...
                <div class="space-y-4">
                        ...
                        <div class="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <h4 class="text-[18px] font-bold text-slate-900">
                                    <?php echo __('exhibit.Targeted_Audience'); ?>

                                </h4>
                                <p class="mt-2 text-[13px] leading-5 text-slate-500">
                                    <?php echo e(__('exhibit.targeted_audience_desc')); ?>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                        <div class="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <h4 class="text-[18px] font-bold text-slate-900">
                                    <?php echo e(__('exhibit.Government_Engagement')); ?>

                                </h4>
                                <p class="mt-2 text-[13px] leading-5 text-slate-500">
                                    <?php echo e(__('exhibit. Government_Engagement_desc')); ?>
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                        <div class="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <h4 class="text-[18px] font-bold text-slate-900">
                                    <?php echo __('exhibit.business_development'); ?>

                                </h4>
                                <p class="mt-2 text-[13px] leading-5 text-slate-500">
                                    <?php echo e(__('exhibit.business_development_desc')); ?>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                        <div class="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <h4 class="text-[18px] font-bold text-slate-900">
                                    <?php echo __('exhibit.brand_building'); ?>

                                </h4>
                                <p class="mt-2 text-[13px] leading-5 text-slate-500">
                                    <?php echo e(__('exhibit.brand_building_desc')); ?>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                        <div class="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                <h4 class="text-[18px] font-bold text-slate-900">
                                    <?php echo __('exhibit.cross_sector_connections'); ?>

                                </h4>
                                <p class="mt-2 text-[13px] leading-5 text-slate-500">
                                    <?php echo e(__('exhibit.cross_sector_connections_desc')); ?>
        ...
        <section class="hidden lg:block w-full bg-white rounded-t-[44px]">
            <div class="mx-auto max-w-6xl px-6 py-12 md:px-10 md:py-14">
                ...
                <div class="grid gap-10 lg:grid-cols-2 lg:gap-14">
                    ...
                    <div>
                        <div class="inline-block">
                            <h3 class="text-[32px] font-extrabold text-sky-600"><?php echo e(__('exhibit.about_why')); ?></h3>
                        ...
                        <div class="mt-6 grid gap-5 sm:grid-cols-2">
                            ...
                            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 class="text-[20px] font-bold leading-7 text-slate-900">
                                            <?php echo e(__('exhibit.Government_Engagement')); ?> <br />
                                        </h4>
                                        <p class="mt-2 text-[15px] leading-5 text-slate-500">
                                            <?php echo e(__('exhibit. Government_Engagement_desc')); ?>
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center">
                <p class="text-[11px] font-semibold tracking-wide text-orange-400">
                    <?php echo e(__('exhibit.form_label')); ?>

                </p>

                <h1 class="mt-2 text-2xl font-extrabold tracking-tight">
                    <?php echo e(__('exhibit.form_title')); ?>

                </h1>

                <p class="mt-3 text-sm leading-6 text-white/60">
                    <?php echo __('exhibit.form_description'); ?>

                </p>
            </div>

            <form action="<?php echo e(route('create.exhibitsubmission')); ?>" method="POST" class="mt-7 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/50">
                        <h3 class="font-bold text-red-400 text-sm mb-2">
                            <?php echo e(__('exhibit.fix_errors')); ?>
                ...
                <?php if(session('success')): ?>
                    <div class="mb-6 p-4 rounded-lg bg-green-500/10 border border-green-500/50">
                        <h3 class="font-bold text-green-400 text-sm"><?php echo e(session('success')); ?></h3>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('error')): ?>
                    <div class="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/50">
                        <h3 class="font-bold text-red-400 text-sm"><?php echo e(session('error')); ?></h3>
                    </div>
                <?php endif; ?>
                ...
                <div id="mobileSuccessMsg"
                    ...
                    <h3 class="font-bold text-green-400 text-sm"><?php echo e(__('exhibit.thank_you')); ?>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.contact_person_label')); ?></label>
                    <input type="text" name="contact_person" required
                        placeholder="<?php echo e(__('exhibit.contact_person_placeholder')); ?>"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.job_title_label')); ?></label>
                    <input type="text" name="job_title" required placeholder="<?php echo e(__('exhibit.job_title_placeholder')); ?>"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.organization_label')); ?></label>
                    <input type="text" name="organization_name" required
                        placeholder="<?php echo e(__('exhibit.organization_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.email_label')); ?></label>
                    <input type="email" name="email_address" required
                        placeholder="<?php echo e(__('exhibit.email_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class=" mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.phone_label')); ?></label>
                    <input type="text" name="phone_number" required placeholder="<?php echo e(__('exhibit.phone_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7 " />
                </div>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label
                            class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.country_label')); ?></label>
                        <div class="relative">
                            <select name="country" required
                                ...
                                <option value="" selected disabled class="bg-slate-900">
                                    <?php echo e(__('exhibit.country_placeholder')); ?>
                    ...
                    <div>
                        <label
                            class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.website_label')); ?></label>
                        <input type="url" name="website" required placeholder="<?php echo e(__('exhibit.website_placeholder')); ?>"
                            class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                    </div>
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.additional_comments_label')); ?></label>
                    <textarea name="additional_comments" rows="4"
                        placeholder="<?php echo e(__('exhibit.additional_comments_placeholder')); ?>"
                ...
                <div class="pt-2">
                    <button type="submit"
                        ...
                        <?php echo e(__('exhibit.submit_button')); ?> <span
            ...
            <div class="mt-8">
                <div class="overflow-hidden rounded-2xl">
                    <img src="<?php echo e(asset('storage/mix/hand-presentation.webp')); ?>" alt=""
            ...
            <div class="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <div>
                    ...
                    <p class="mt-3 max-w-xl text-sm leading-6 text-white/60">
                        <?php echo e(__('exhibit.form_description')); ?>
                    ...
                    <form action="<?php echo e(route('create.exhibitsubmission')); ?>" method="POST" class="mt-7 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="job_title" required
                                placeholder="<?php echo e(__('exhibit.job_title_placeholder')); ?>"
                                class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" required
                                    placeholder="<?php echo e(__('exhibit.phone_placeholder')); ?>"
                                    class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="url" name="website" required
                                    placeholder="<?php echo e(__('exhibit.website_placeholder')); ?>"
                                    class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                            </div>
                        ...
                        <div>
                            <label
                                class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('exhibit.additional_comments_label')); ?>

                            </label>
                            <textarea name="additional_comments" rows="4"
                                placeholder="<?php echo e(__('exhibit.additional_comments_placeholder')); ?>" class="w-full rounded-md border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50
                ...
                <div class="lg:pt-8">
                    <div class="relative mx-auto w-[457px] max-w-md lg:max-w-none">
                        <div class="overflow-hidden rounded-[28px]">
                            <img src="<?php echo e(asset('storage/mix/exhbit-form.webp')); ?>" alt=""
...
</html><?php /**PATH C:\laragon\www\SCW-app\resources\views/exhibit.blade.php ENDPATH**/ ?>