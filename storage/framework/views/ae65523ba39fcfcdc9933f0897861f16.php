...
<?php $__env->startSection('title', 'Exhibit Submissions | User Dashboard'); ?>

<?php $__env->startSection('header-title', 'Exhibit Submissions'); ?>
<?php $__env->startSection('header-subtitle', 'View your exhibit submissions'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">My Exhibit Submissions</h3>
                <p class="text-sm text-gray-500 mt-1">Total: <?php echo e(count($submissions)); ?> submissions</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('user.exhibit-submissions.exportExcel')); ?>"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="<?php echo e(route('user.exhibit-submissions.search')); ?>"
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <?php if($submissions->isEmpty()): ?>
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500">Your exhibit submissions will appear here.</p>
                </div>
            <?php else: ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="min-w-0">
                                                <p class="font-medium text-gray-900 truncate"><?php echo e($submission->contact_person); ?>
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="tel:<?php echo e($submission->phone_number); ?>"
                                            class="text-gray-700 text-xs whitespace-nowrap"><?php echo e($submission->phone_number); ?></a>
                                    </td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-end gap-1">
                                            <a href="<?php echo e(route('user.exhibit-submissions.show', $submission->id)); ?>"
...
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SCW-app\resources\views/user/exhibitsubmissions/index.blade.php ENDPATH**/ ?>