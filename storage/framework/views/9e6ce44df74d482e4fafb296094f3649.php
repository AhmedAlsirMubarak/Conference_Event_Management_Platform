...
<body class="overflow-x-hidden">
    ...
    <section class="hidden lg:block">
        <div class="relative w-full h-[633px]">
            ...
            <img src="/images/mix/<?php echo e(app()->getLocale() === 'ar' ? 'home-dark-bg.webp' : 'home-dark-bg.webp'); ?>"
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div class="flex items-end gap-8 mt-16">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <span class="text-4xl font-bold text-white leading-tight">
                            <?php echo e(__('hero.location_city')); ?>

                        </span>
                        <span class="text-2xl font-medium text-white leading-snug">
                            <?php echo e(__('hero.location_country')); ?>
                    ...
                    <div class="flex flex-col items-center text-center">
                        <span class="text-4xl font-bold text-white leading-tight">
                            <?php echo e(__('hero.date')); ?>

                        </span>
                        <span class="text-2xl font-medium text-white leading-snug">
                            <?php echo e(__('hero.date_month')); ?>
                ...
                <div class="flex items-center gap-4 mt-12">
                    <a href="#speakers" class="px-8 py-3 bg-[#7D876B] hover:bg-[#6d765b] text-white font-semibold rounded-lg transition-colors duration-300">
                        <?php echo e(__('hero.button_speakers') ?? 'Speakers'); ?>
                    ...
                    <a href="#exhibitors" class="px-8 py-3 bg-[#E6813E] hover:bg-[#d96e2f] text-white font-semibold rounded-lg transition-colors duration-300">
                        <?php echo e(__('hero.button_exhibitors') ?? 'Exhibitors'); ?>
    ...
    <section class="hidden lg:block relative z-10">
        <div class="w-full max-w-[1168px] h-[498px] bg-gray-900 rounded-[20px] mx-auto mt-20 mb-0 overflow-hidden  ">
            ...
            <div class="flex flex-row h-full ">
                ...
                <div
                    class="w-1/2 pt-20 pb-12 <?php echo e(app()->getLocale() === 'ar' ? 'pl-12 pr-20 text-right' : 'pl-20 pr-12 text-left'); ?> flex flex-col justify-center">

                    
                    <span class="text-[#E6813E] text-base font-semibold mb-2">
                        <?php echo e(__('hero.event_label')); ?>

                    </span>

                    
                    <h2 class="text-4xl font-bold text-white mb-4">
                        <?php echo e(__('hero.event_title')); ?>

                    </h2>

                    
                    <p class="text-gray-300 text-base mb-2 leading-relaxed">
                        <?php echo e(__('hero.event_desc_1')); ?>

                    </p>

                    <p class="text-gray-300 text-base mb-6 leading-relaxed">
                        <?php echo e(__('hero.event_desc_2')); ?>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center gap-2 mb-4">
                            <div>
                                <img src="/images/mix/Radar-animation.gif" class="h-[45px] w-[45px]"
                                    alt="Pillars Icon" />
                            </div>
                            <h3 class="text-xl font-bold text-white">
                                <?php echo e(__('hero.event_pillars')); ?>
                ...
                <div class="w-1/2 flex items-center justify-center p-12">
                    <div class="w-full h-full rounded-lg overflow-hidden shadow-lg">
                        <img src="/images/mix/hero-info.webp" alt="Event Team" class="w-full h-full object-cover">
                    </div>
                </div>
        ...
        <div
            ...
            <div class="flex flex-col">
                ...
                <div class="w-full h-64 md:h-80 flex items-center justify-center overflow-hidden">
                    <img src="/images/mix/hero-info.webp" alt="Event Team" class="max-w-[250px] h-full object-cover">
                </div>
                ...
                <div class="w-full flex flex-col items-center justify-start p-6 md:p-8 text-center">
                    ...
                    <div class="mb-4 w-full">
                        <div class="flex items-center gap-2 mb-3 justify-center">
                            <div>
                                <img src="/images/mix/Radar-animation.gif" class="h-8 w-8 md:h-10 md:w-10"
                                    alt="Pillars Icon" />
                            </div>
    ...
    <section class="hidden lg:block bg-[#121D24] text-white mt-[-15%] pt-[250px]  relative">
        <div class="mx-auto max-w-6xl px-4 py-10 sm:py-12">
            ...
            <h3 class="text-center text-2xl font-bold tracking-wide">
                <?php echo e(__('hero.event_state_title')); ?>
            ...
            <div class="mt-10 grid grid-cols-2 gap-y-10 text-center sm:grid-cols-3 lg:grid-cols-6">
                <div>
                    ...
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_speakers')); ?></div>
                </div>

                <div>
                    <div class="text-2xl font-bold counter" data-target="1700">0</div>
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_participants')); ?></div>
                </div>

                <div>
                    <div class="text-2xl font-bold counter" data-target="8000">0</div>
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_visitors')); ?></div>
                </div>

                <div>
                    <div class="text-2xl font-bold counter" data-target="45">0</div>
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_exhibitors')); ?></div>
                </div>

                <div>
                    <div class="text-2xl font-bold counter" data-target="40">0</div>
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_countries')); ?></div>
                </div>

                <div>
                    <div class="text-2xl font-bold counter-4m" data-target="4">0</div>
                    <div class="mt-2 text-[20px] text-white/70"><?php echo e(__('hero.stat_media_impact')); ?></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-6xl px-4 py-8 md:py-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                <div class="text-center">
                    ...
                    <div class="mt-2 text-sm md:text-base text-white/70"><?php echo e(__('hero.stat_speakers')); ?></div>
                </div>

                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold counter" data-target="1700">0</div>
                    <div class="mt-2 text-sm md:text-base text-white/70"><?php echo e(__('hero.stat_participants')); ?></div>
                </div>

                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold counter" data-target="8000">0</div>
                    <div class="mt-2 text-sm md:text-base text-white/70"><?php echo e(__('hero.stat_visitors')); ?></div>
                </div>

                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold counter" data-target="45">0</div>
                    <div class="mt-2 text-sm md:text-base text-white/70"><?php echo e(__('hero.stat_exhibitors')); ?></div>
                </div>

                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold counter" data-target="40">0</div>
                    <div class="mt-2 text-sm md:text-base text-white/70"><?php echo e(__('hero.stat_countries')); ?></div>
                </div>

                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold counter-4m" data-target="4">0</div>
                    <div class="mt-2 text-xs md:text-sm text-white/70"><?php echo e(__('hero.stat_media_impact')); ?></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="w-full h-12 md:h-14 bg-[#3C94C5] flex items-center justify-center">
            <div class="flex items-center h-full max-w-6xl mx-auto px-4 gap-3 md:gap-4 w-full justify-center">
                ...
                <div class="flex flex-shrink-0 <?php echo e(app()->getLocale() === 'ar' ? 'order-last' : 'order-first'); ?>">
                    <img src="/images/mix/<?php echo e(app()->getLocale() === 'ar' ? 'Left-arrow.svg' : 'right-arrow.svg'); ?>"
                        alt="Arrow" class="w-6 h-4 md:w-7">
                </div>
                
                <div class="flex items-center justify-center">
                    <span class="text-white text-sm md:text-xl font-bold leading-6 md:leading-8">
                        <?php echo e(__('hero.speaker_banner')); ?>
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-6 p-2 sm:p-3 sm:grid-cols-2 lg:grid-cols-4 justify-items-center">
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    ...
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#7D876B]
                        ...
                        <img src="/images/mix/city-energy.gif" alt="Innovation" class="h-[93px] w-[166px]" />
                    </div>

                    <!-- Body -->
                    <div class="px-4 py-6 <?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                        <h3 class="text-[18px] sm:text-[20px] font-bold text-slate-900">
                            <?php echo e(__('hero.card_1_title')); ?>

                        </h3>
                        <p class="mt-3 text-[14px] sm:text-[15px] leading-6 text-slate-500">
                            <?php echo e(__('hero.card_1_desc')); ?>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#E7B954]
                        rounded-t-[20px] rounded-b-none">
                        <img src="/images/mix/city-planning.gif" alt="Adaptation" class="h-[95px] w-[169px]" />
                    </div>

                    <div class="px-4 py-6 <?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                        <h3 class="text-[18px] sm:text-[20px] font-bold text-slate-900">
                            <?php echo e(__('hero.card_2_title')); ?>

                        </h3>
                        <p class="mt-3 text-[14px] sm:text-[15px] leading-6 text-slate-500">
                            <?php echo e(__('hero.card_2_desc')); ?>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#3C94C5]
                        rounded-t-[20px] rounded-b-none">
                        <img src="/images/mix/Recycling.gif" alt="Circular Economy" class="h-[88px] w-[156px]" />
                    </div>

                    <div class="px-4 py-6 <?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                        <h3 class="text-[18px] sm:text-[20px] font-bold text-slate-900">
                            <?php echo e(__('hero.card_3_title')); ?>

                        </h3>
                        <p class="mt-3 text-[14px] sm:text-[15px] leading-6 text-slate-500">
                            <?php echo e(__('hero.card_3_desc')); ?>
                ...
                <div class="w-full max-w-sm rounded-[28px] border border-[#CBD5E1] bg-white p-4">
                    <div class="flex h-[110px] items-center justify-center overflow-hidden bg-[#E68238]
                        rounded-t-[20px] rounded-b-none">
                        <img src="/images/mix/Investment-icon.gif" alt="Climate Finance" class="h-[98px] w-[98px]" />
                    </div>

                    <div class="px-4 py-6 <?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                        <h3 class="text-[18px] sm:text-[20px] font-bold text-slate-900">
                            <?php echo e(__('hero.card_4_title')); ?>

                        </h3>
                        <p class="mt-3 text-[14px] sm:text-[15px] leading-6 text-slate-500">
                            <?php echo e(__('hero.card_4_desc')); ?>
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
                ...
                <div class="grid gap-6 lg:col-span-4 justify-items-center lg:justify-items-start">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        <img src="/images/mix/book.svg" class="w-[49px] h-[45px]" alt="">
                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-xl font-semibold text-[#121D24]">
                                <?php echo e(__('hero.attendee_research_institutions')); ?>

                            </p>
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_universities')); ?></p>
                        </div>
                    </div>
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="/images/mix/world.svg" class="w-[49px] h-[49px]" alt="">

                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-[19px] font-semibold text-[#121D24]">
                                <?php echo e(__('hero.attendee_international_orgs')); ?>

                            </p>
                            <p class="text-[19px] font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_ngos')); ?></p>
                        </div>
                    </div>
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="/images/mix/chart.svg" class="w-[49px] h-[49px]" alt="">

                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_investors_banks')); ?>

                            </p>
                            <p class="text-xl font-semibold text-[#121D24]">
                                <?php echo e(__('hero.attendee_financial_institutions')); ?>
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="mx-auto max-w-[320px] overflow-hidden rounded-2xl border border-slate-200">
                        <img src="/images/mix/attendee-section.webp" alt="Attendees"
                    ...
                    <div class="mx-auto mt-6 max-w-[360px]">
                      ...
                      shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                            ...
                            <img src="/images/mix/newspaper.svg" class="w-[49px] h-[49px]" alt="">

                            <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                                <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_media_outlets')); ?>

                                </p>
                                <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_news_agencies')); ?>
                ...
                <div class="grid gap-6 lg:col-span-4 justify-items-center lg:justify-items-start">
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="/images/mix/building.svg" class="w-[49px] h-[49px]" alt="">

                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_gov_agencies')); ?></p>
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_regulatory_bodies')); ?>
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="/images/mix/industry.svg" class="w-[49px] h-[49px]" alt="">

                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-xl font-semibold text-[#121D24]">
                                <?php echo e(__('hero.attendee_national_authorities')); ?>

                            </p>
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_energy_climate')); ?>
                    ...
                    shadow-[0_6px_24px_rgba(0,0,0,0.06)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 rounded-lg cursor-pointer">
                        ...
                        <img src="/images/mix/rocket.svg" class="w-[49px] h-[49px]" alt="">

                        <div class="<?php echo e(app()->getLocale() === 'ar' ? 'text-right' : 'text-left'); ?>">
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_tech_providers')); ?>

                            </p>
                            <p class="text-xl font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_startups')); ?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mx-auto max-w-6xl px-4 pb-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/book.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[45px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        ...
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_universities')); ?>
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/world.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_international_orgs')); ?>
                        ...
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_ngos')); ?></p>
                    </div>
                </div>
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/chart.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_investors_banks')); ?>
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/building.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_gov_agencies')); ?>

                        </p>
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_regulatory_bodies')); ?>
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/industry.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_national_authorities')); ?>
                        ...
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_energy_climate')); ?>
                ...
                border border-slate-50 min-h-[100px]
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/rocket.svg" class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0"
                        alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_tech_providers')); ?>

                        </p>
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]"><?php echo e(__('hero.attendee_startups')); ?>
                ...
                shadow-[0_6px_24px_rgba(0,0,0,0.06)] rounded-lg sm:col-span-2 transition-all duration-300 hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] hover:scale-105 cursor-pointer">
                    <img src="/images/mix/newspaper.svg"
                        class="w-[40px] sm:w-[49px] h-[40px] sm:h-[49px] flex-shrink-0" alt="">
                    <div class="text-center">
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_media_outlets')); ?>

                        </p>
                        <p class="text-sm sm:text-base font-semibold text-[#121D24]">
                            <?php echo e(__('hero.attendee_news_agencies')); ?>
    ...
    <section class="hidden lg:block relative bg-slate-950 py-14 sm:py-20 text-white overflow-hidden"
        ...
        <div class="relative mx-auto max-w-6xl px-4">
            ...
            <div class="text-center">
                <p class="text-xl font-bold text-orange-500">
                    <?php echo e(__('hero.program_label')); ?>

                </p>
                <h2 class="mt-2 text-2xl sm:text-3xl font-bold">
                    <?php echo e(__('hero.program_title')); ?>

                </h2>
                <p class="mt-3 text-sm sm:text-base text-white/70">
                    <?php echo e(__('hero.program_subtitle')); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        <img src="/images/mix/back-icon.webp" alt=""
                            class="absolute inset-0 h-full w-full object-cover" />
                        <div class="absolute inset-0"></div>

                        <!-- ICON -->
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/police.svg" alt="" class="h-10 w-10" />
                        </div>
                    </div>
                    ...
                    <div class="p-6 text-center">
                        <h3 class="text-lg font-bold leading-8">
                            <?php echo e(__('hero.program_card_1_title')); ?>

                        </h3>
                        <p class="mt-4 text-sm leading-7 text-white/70">
                            <?php echo e(__('hero.program_card_1_desc')); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/graduation-cap.svg" alt="" class="h-10 w-10" />
                        </div>
                    </div>

                    <div class="p-6 text-center">
                        <h3 class="text-lg font-bold leading-8">
                            <?php echo e(__('hero.program_card_2_title')); ?>

                        </h3>
                        <p class="mt-4 text-sm leading-7 text-white/70">
                            <?php echo e(__('hero.program_card_2_desc')); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/bubble.svg" alt="" class="h-10 w-10" />
                        </div>
                    </div>

                    <div class="p-6 text-center">
                        <h3 class="text-lg font-bold leading-8">
                            <?php echo e(__('hero.program_card_3_title')); ?>

                        </h3>
                        <p class="mt-4 text-sm leading-7 text-white/70">
                            <?php echo e(__('hero.program_card_3_desc')); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/discussion.svg" alt="" class="h-10 w-10" />
                        </div>
                    </div>

                    <div class="p-6 text-center">
                        <h3 class="text-lg font-bold leading-8">
                            <?php echo e(__('hero.program_card_4_title')); ?>

                        </h3>
                        <p class="mt-4 text-sm leading-7 text-white/70">
                            <?php echo e(__('hero.program_card_4_desc')); ?>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <!-- ICON -->
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/police.svg" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/graduation-cap.svg" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/bubble.svg" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
                ...
                <div class="relative overflow-hidden rounded-lg md:rounded-2xl bg-white/[0.06]
                  ...
                  shadow-[0_22px_55px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="relative h-28 md:h-36">
                        ...
                        <div class="absolute inset-0"></div>
                        <div class="relative z-10 flex h-full items-center justify-center">
                            <img src="/images/mix/discussion.svg" alt="" class="h-8 md:h-10 w-8 md:w-10" />
                        </div>
                    </div>
...
</html><?php /**PATH C:\laragon\www\SCW-app\resources\views/Home.blade.php ENDPATH**/ ?>