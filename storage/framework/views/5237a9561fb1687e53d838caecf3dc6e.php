    ...
    <div class="px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="hidden lg:block relative">
                <form action="<?php echo e(route('user.search')); ?>" method="GET" class="flex items-center">
            ...
            <!-- Notification Bell -->
            <?php echo $__env->make('components.notification-bell', ['notificationRole' => 'user'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</header><?php /**PATH C:\laragon\www\SCW-app\resources\views/user/partials/header.blade.php ENDPATH**/ ?>