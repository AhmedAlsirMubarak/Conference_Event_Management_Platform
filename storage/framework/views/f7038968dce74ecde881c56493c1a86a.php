                        ...
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="flex items-center space-x-2">
                                <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($loop->last): ?>
                                        <li class="text-gray-500 text-sm"><?php echo e($breadcrumb['name']); ?></li>
                                    <?php else: ?>
                                        <li>
                                            <a href="<?php echo e($breadcrumb['url']); ?>" class="text-green-600 hover:text-green-800 text-sm">
            ...
            <footer class="bg-white border-t border-gray-200 px-3 sm:px-6 py-4">
                <div class="text-center text-xs text-gray-600">
                    <p>© 2025 developed by <a href="https://www.linkedin.com/in/ahmed-alsir-20a3a8151/" target="_blank"
                            rel="noopener noreferrer" class="text-green-600 hover:text-green-700 font-medium">Ahmed
                            Alsir Mubarak</a>. All rights reserved.</p>
                </div>
            </footer>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\SCW-app\resources\views/user/layouts/app.blade.php ENDPATH**/ ?>