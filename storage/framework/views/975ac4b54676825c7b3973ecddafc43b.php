<div id="notification-container" class="relative">
    ...
    <button id="notification-bell" class="relative p-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
        aria-label="Notifications" data-user-role="<?php echo e($roleForBell); ?>" data-user-id="<?php echo e(Auth::id()); ?>"
        data-is-admin="<?php echo e($isAdminRole ? 'true' : 'false'); ?>"
        data-unread-url="<?php echo e($isAdminRole ? route('admin.notifications.unread') : route('user.notifications.unread')); ?>"
        data-mark-all-url="<?php echo e($isAdminRole ? route('admin.notifications.markAllRead') : route('user.notifications.markAllRead')); ?>"
        data-index-url="<?php echo e($isAdminRole ? route('admin.notifications.index') : route('user.notifications.index')); ?>"
        data-delete-prefix="<?php echo e($isAdminRole ? '/api/notifications' : '/user/api/notifications'); ?>">
...
</script><?php /**PATH C:\laragon\www\SCW-app\resources\views/components/notification-bell.blade.php ENDPATH**/ ?>