...
<head>
    ...
    <title><?php echo e(__(key: 'speakers.hero_title')); ?></title>
    <meta name="description" content="<?php echo e(__('speakers.meta_description')); ?>">
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(__('speakers.page_title')); ?>">
...
<body class="overflow-x-hidden" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <section class="lg:hidden relative w-full overflow-hidden h-[400px]">
        ...
        <div class="absolute inset-0 bg-center bg-cover"
            style="background-image: url('<?php echo e(asset('storage/mix/speakers-hero.webp')); ?>');" aria-hidden="true"></div>
            ...
            <div class="text-center max-w-md">
                ...
                <div class="mt-6">
                    <a href="#speaker-enquiry-form"
                        ...
                        <?php echo e(__('speakers.hero_cta')); ?>
    ...
    <section class="lg:hidden bg-white py-12 px-4">
        <div class="max-w-md mx-auto text-center">
            ...
            <p class="text-2xl font-bold text-slate-900 leading-tight">
                <?php echo e(__('speakers.section_intro')); ?>
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-3">
                <span
                    ...
                    <?php echo e(__('speakers.policy')); ?>

                </span>
                <span
                    class="inline-flex items-center rounded-full bg-[#E68238]/35 px-4 py-2 text-lg font-semibold text-slate-900">
                    <?php echo e(__('speakers.innovation')); ?>

                </span>
                <span
                    class="inline-flex items-center rounded-full bg-[#E68238]/35 px-4 py-2 text-lg font-semibold text-slate-900">
                    <?php echo e(__('speakers.investment')); ?>

                </span>
                <span
                    class="inline-flex items-center rounded-full bg-[#E68238]/35 px-4 py-2 text-lg font-semibold text-slate-900">
                    <?php echo e(__('speakers.implementation')); ?>
            ...
            <div class="inline-block">
                <h3 class="text-2xl font-extrabold text-sky-600">
                    <?php echo e(__('speakers.take_part_title')); ?>
            ...
            <ul class="mt-6 space-y-4 text-center">
                <li class="flex items-center justify-center gap-4">
                    ...
                    <p class="text-lg font-semibold text-slate-900"><?php echo e(__('speakers.keynote_sessions')); ?></p>
                </li>
                <li class="flex items-center justify-center gap-4">
                    <img src="/storage/mix/discussion-group.svg" class="w-8 h-8" alt="">
                    <p class="text-lg font-semibold text-slate-900"><?php echo e(__('speakers.panels')); ?></p>
                </li>
                <li class="flex items-center justify-center gap-4">
                    <img src="/storage/mix/workshop.svg" class="w-8 h-8" alt="">
                    <p class="text-lg font-semibold text-slate-900"><?php echo e(__('speakers.workshops')); ?></p>
                </li>
                <li class="flex items-center justify-center gap-4">
                    <img src="/storage/mix/sessions.svg" class="w-8 h-8" alt="">
                    <p class="text-lg font-semibold text-slate-900"><?php echo e(__('speakers.technical_sessions')); ?></p>
                </li>
            </ul>
        </div>
    </section>
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-5">
                        <li class="flex items-start gap-4">
                            ...
                            <p class="text-[27px] font-semibold text-slate-900"><?php echo e(__('speakers.keynote_sessions')); ?>

                            </p>
                        </li>
                        <li class="flex items-start gap-4">
                            <img src="/storage/mix/discussion-group.svg" class="w-10 h-10" alt="">
                            <p class="text-[27px] font-semibold text-slate-900"><?php echo e(__('speakers.panels')); ?></p>
                        </li>
                        <li class="flex items-start gap-4">
                            <img src="/storage/mix/workshop.svg" class="w-10 h-10" alt="">
                            <p class="text-[27px] font-semibold text-slate-900"><?php echo e(__('speakers.workshops')); ?></p>
                        </li>
                        <li class="flex items-start gap-4">
                            <img src="/storage/mix/sessions.svg" class="w-10 h-10" alt="">
                            <p class="text-[27px] font-semibold leading-9 text-slate-900">
                                <?php echo e(__('speakers.technical_sessions')); ?>
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center">
                <p class="text-[11px] font-semibold tracking-wide text-orange-400">
                    <?php echo e(__('speakers.form_label')); ?>

                </p>

                <h1 class="mt-2 text-2xl font-extrabold tracking-tight">
                    <?php echo e(__('speakers.form_title')); ?>

                </h1>

                <p class="mt-3 text-sm leading-6 text-white/60">
                    <?php echo e(__('speakers.form_description')); ?>

                </p>
            </div>

            <form action="<?php echo e(route('create.speakersubmission')); ?>" method="POST" class="mt-7 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/50">
                        <h3 class="font-bold text-red-400 text-sm mb-2">
                            <?php echo e(__('speakers.fix_errors')); ?>
                ...
                <div id="mobileSuccessMsg"
                    ...
                    <h3 class="font-bold text-green-400 text-sm"><?php echo e(__('speakers.thank_you')); ?>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.contact_person_label')); ?></label>
                    <input type="text" name="contact_person" required
                        placeholder="<?php echo e(__('speakers.contact_person_placeholder')); ?>"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.job_title_label')); ?></label>
                    <input type="text" name="job_title" required
                        placeholder="<?php echo e(__('speakers.job_title_placeholder')); ?>"
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.organization_label')); ?></label>
                    <input type="text" name="organization_name" required
                        placeholder="<?php echo e(__('speakers.organization_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.email_label')); ?></label>
                    <input type="email" name="email_address" required
                        placeholder="<?php echo e(__('speakers.email_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.phone_label')); ?></label>
                    <input type="text" name="phone_number" required placeholder="<?php echo e(__('speakers.phone_placeholder')); ?>"
                        class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                </div>

                
                <div>
                    <label class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.country')); ?></label>
                    <div class="relative">
                        <select name="country" required
                            ...
                            <option value="" selected disabled class="bg-slate-900"><?php echo e(__('speakers.select_country')); ?>
                ...
                <div>
                    <label
                        class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.speaker_bio_label')); ?></label>
                    <textarea name="speaker_biography" required rows="4"
                        placeholder="<?php echo e(__('speakers.speaker_bio_placeholder')); ?>"
                ...
                <div class="pt-2">
                    <button type="submit"
                        ...
                        <?php echo e(__('speakers.submit_button')); ?> <span
            ...
            <div class="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <div>
                    ...
                    <form action="<?php echo e(route('create.speakersubmission')); ?>" method="POST" class="mt-7 space-y-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" required
                                    placeholder="<?php echo e(__('speakers.phone_placeholder')); ?>"
                                    class="h-11 w-full rounded-md border border-white/10 bg-white/5 px-4 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50 focus:bg-white/7" />
                            </div>
                        </div>
                        ...
                        <div>
                            <label
                                class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.country')); ?></label>
                            <div class="relative">
                                <select name="country" required
                                    class="h-11 w-full appearance-none rounded-md border border-white/10 bg-white/5 px-4 pr-10 text-sm text-white outline-none transition focus:border-orange-400/50 focus:bg-white/7">
                                    <option value="" selected disabled class="bg-slate-900">
                                        <?php echo e(__('speakers.select_country')); ?>
                        ...
                        <div>
                            <label
                                class="mb-2 block text-xs font-semibold text-white/70"><?php echo e(__('speakers.speaker_bio_label')); ?>

                            </label>
                            <textarea name="speaker_biography" required rows="4"
                                placeholder="<?php echo e(__('speakers.speaker_bio_placeholder')); ?>" class="w-full rounded-md border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/35 outline-none transition focus:border-orange-400/50
...
</html><?php /**PATH C:\laragon\www\SCW-app\resources\views/speakers.blade.php ENDPATH**/ ?>