<?php $__env->startSection('title', 'Exhibitors | Admin Dashboard'); ?>

<?php $__env->startSection('header-title', 'Exhibitors'); ?>
<?php $__env->startSection('header-subtitle', 'Manage all exhibitors'); ?>
    ...
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Total: <?php echo e(count($exhibitors)); ?> exhibitors</p>
            </div>
            <a href="<?php echo e(route('exhibitors.create')); ?>"
        ...
        <!-- Search Form -->
        <div class="mb-6">
            <form action="<?php echo e(route('exhibitors.search')); ?>" method="GET"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $exhibitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exhibitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                    <!-- Logo Section -->
                    <div class="h-40 bg-gray-100 flex items-center justify-center overflow-hidden">
                        <?php if($exhibitor->logo): ?>
                            <img src="<?php echo e(asset(path: $exhibitor->logo)); ?>" alt="<?php echo e($exhibitor->name); ?>"
                    ...
                    <!-- Content Section -->
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-2"><?php echo e($exhibitor->name); ?></h3>

                        <?php if($exhibitor->website): ?>
                            <p class="text-sm text-gray-600 mb-4">
                                <a href="<?php echo e($exhibitor->website); ?>" target="_blank"
                                    class="text-blue-600 hover:text-blue-800 break-all">
                                    <?php echo e($exhibitor->website); ?>
                        ...
                        <div class="flex items-center gap-2 pt-4 border-t border-gray-200">
                            <a href="<?php echo e(route('exhibitors.show', $exhibitor->id)); ?>"
                            ...
                            <a href="<?php echo e(route('exhibitors.edit', $exhibitor->id)); ?>"
                            ...
                            <form action="<?php echo e(route('exhibitors.destroy', $exhibitor->id)); ?>" method="POST" class="flex-1"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SCW-app\resources\views/admin/exhibitors/index.blade.php ENDPATH**/ ?>