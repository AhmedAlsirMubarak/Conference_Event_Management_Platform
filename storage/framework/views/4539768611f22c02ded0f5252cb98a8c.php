...
<?php $__env->startSection('header-subtitle', 'Welcome to your admin panel'); ?>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalContacts ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($thisWeekContacts ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($todayContacts ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalSponsors ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalSpeakersSubmissions ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalExhibitSubmissions ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalStrategicSpeakers ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalTechnicalSpeakers ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalStrategicCommittees ?? 0); ?></p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($totalTechnicalCommittees ?? 0); ?></p>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SCW-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>