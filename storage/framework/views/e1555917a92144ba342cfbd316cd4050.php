...
<?php $__env->startSection('title', 'Speaker Submissions | Admin Dashboard'); ?>

<?php $__env->startSection('header-title', 'Speaker Submissions'); ?>
<?php $__env->startSection('header-subtitle', 'Manage all speaker submissions'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-col">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">All Speaker Submissions</h3>
                <p class="text-sm text-gray-500 mt-1">Total: <?php echo e(count($submissions)); ?> submissions</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('speaker-submissions.exportExcel')); ?>"
        ...
        <!-- Search Bar -->
        <div class="mb-6">
            <form method="GET" action="<?php echo e(route('speaker-submissions.search')); ?>" class="flex flex-col sm:flex-row gap-2">
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <?php if($submissions->isEmpty()): ?>
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500">Speaker submissions will appear here.</p>
                </div>
            <?php else: ?>
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors submission-row"
                                            ...
                                            <div class="flex items-center gap-1">
                                                <?php if($submission->notes): ?>
                                                    <div class="flex-1 min-w-0">
                                                        <p class="text-xs text-gray-700 line-clamp-1" title="<?php echo e($submission->notes); ?>">
                                                            <?php echo e(Str::limit($submission->notes, 30)); ?>

                                                        </p>
                                                    </div>
                                                    <button type="button"
                                                        onclick="openNoteModal(<?php echo e($submission->id); ?>, '<?php echo e(addslashes($submission->notes)); ?>')"
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-end gap-1">
                                                <a href="<?php echo e(route('speaker-submissions.show', $submission->id)); ?>"
                                                ...
                                                <?php if(Auth::check()): ?>
                                                    <form action="<?php echo e(route('speaker-submissions.destroy', $submission->id)); ?>"
    ...
    <script>
        function openNoteModal(submissionId, noteText) {
            ...
            form.action = `/admin/speaker-submissions/${submissionId}/notes`;
        ...
        function confirmBulkDelete() {
            ...
            submissionIds.forEach(id => {
                fetch(`/admin/speaker-submissions/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': token,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SCW-app\resources\views/admin/speakerssubmissions/index.blade.php ENDPATH**/ ?>