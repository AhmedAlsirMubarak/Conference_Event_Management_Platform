...
class ClimateLeaderSubmissionNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Thank you for your nomination to become a Climate Leader at Saudi Climate Week 2026!')
            ->line('We have successfully received your submission with the following details:')
            ...
            ->line('LinkedIn: ' . ($this->climateLeader->linkedin_profile ?? 'Not provided'))
            ->line('')
            ->line('Our team will review your nomination and get back to you soon.')
            ->line('Thank you for your commitment to climate leadership!')
            ->line('Best regards,')
